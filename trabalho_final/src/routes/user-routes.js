...
const { signup, login, resetPassword, uploadProfileImage } = require('../controllers/user-controller'); // Importa os controladores para as funções de signup, login e reset de senha
